...
int position_y;
int position_z;
// Preserve the existing process-wide parameter storage and lifetime.
std::string imu_topic;  // NOLINT(runtime/string)
std::string imu_frame_id, world_frame_id;  // NOLINT(runtime/string)
...
public:
  ...
  : Node("imu_data_to_tf")
  {
    ...
    sub_ =
      ...
      imu_topic.c_str(), 10,
      std::bind(&imu_data_to_tf::ImuCallback, this, _1));
  }
