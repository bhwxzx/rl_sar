#ifndef AHRS_DRIVER_H_
#define AHRS_DRIVER_H_
...
public:
  ...
  void magCalculateYaw(
    double roll, double pitch, double & magyaw, double magx, double magy,
    double magz);
...
private:
  ...
  std::string gps_topic = "/gps/fix", twist_topic = "/system_speed",
